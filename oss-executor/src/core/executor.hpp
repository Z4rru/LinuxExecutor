...
public:
    ...
    void enqueue_script(const std::string& script, const std::string& name = "queued", int priority = 0);
...
private:
    ...
    ExecutionResult execute_internal(const std::string& script, const std::string& name);
    void process_queue();
